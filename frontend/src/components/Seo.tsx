...
export function RouteSeo() {
  ...
  const pages: Record<string, { title: string; description: string }> = {
    ...
    '/about': { title: 'О мастерской ВоскоСвет', description: 'История и ценности мастерской натуральных свечей ВоскоСвет.' },
    '/craft': { title: 'Путь свечи — ВоскоСвет', description: 'Видео о создании свечей и советы по использованию пчелиного воска.' },
