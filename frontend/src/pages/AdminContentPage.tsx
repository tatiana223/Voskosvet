...
const deliveryFields: Field[] = [
  ...
  { key: 'delivery.option1Title', label: 'Доставка 1 — название' },
  { key: 'delivery.option1Text', label: 'Доставка 1 — описание', multiline: true },
  { key: 'delivery.option1Term', label: 'Доставка 1 — срок' },
  { key: 'delivery.option1Note', label: 'Доставка 1 — примечание', multiline: true },
  { key: 'delivery.option2Title', label: 'Доставка 2 — название' },
  { key: 'delivery.option2Text', label: 'Доставка 2 — описание', multiline: true },
  { key: 'delivery.option2Term', label: 'Доставка 2 — срок' },
  { key: 'delivery.option2Note', label: 'Доставка 2 — примечание', multiline: true },
  { key: 'delivery.option3Title', label: 'Доставка 3 — название' },
  { key: 'delivery.option3Text', label: 'Доставка 3 — описание', multiline: true },
  { key: 'delivery.option3Term', label: 'Доставка 3 — срок' },
  { key: 'delivery.option3Note', label: 'Доставка 3 — примечание', multiline: true },
